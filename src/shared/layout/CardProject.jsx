...
export default function CardProject({title, description, src, link}) {
    return (
        ...
        <div className="max-w-xs mx-4 p-6 justify-center bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <img className="rounded-t-sm" src={src} alt="" />
            </a>
            <div class="p-5">
                <a href="#">
